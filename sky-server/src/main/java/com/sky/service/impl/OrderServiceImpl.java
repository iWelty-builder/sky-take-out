...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderVO detail(Integer id) {
        ...
        orderVO.setAddress(byId.getProvinceName() + byId.getCityName() + byId.getDistrictName() +byId.getDetail());
...
//            log.info("申请退款：{}", refund);
    ...
    public void cancel1(OrdersCancelDTO ordersCancelDTO) throws Exception {
        // 根据id查询订单
...
//            log.info("申请退款：{}", refund);
    ...
    public void remind(Long id) {
        ...
        map.put("type",2);
        map.put("orderId",id);
        OrderVO byId = orderMapper.getById(Math.toIntExact(id));
        if (byId == null){
            throw new OrderBusinessException(MessageConstant.ORDER_NOT_FOUND);
        }
